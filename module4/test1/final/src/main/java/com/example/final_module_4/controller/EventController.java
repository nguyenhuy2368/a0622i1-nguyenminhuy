...
public class EventController {
    ...
    public String search(Model model,
                         @RequestParam(value = "mucGiamGia", defaultValue = " ") Double mucGiamGia,
        ...
        model.addAttribute("list", eventService.findByMucGiamGiaContainingAndTgBatDauContainingAndTgKetThucContaining(mucGiamGia, tgBatDau, tgKetThuc));
        return "index";
    }
